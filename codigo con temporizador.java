			...
			switch (opcion) {
				case 1: // Encriptar
                    System.out.print("Ingrese el mensaje a encriptar: ");
                        ...
                        // esto de acá se supone que nos dirá el tiempo
                    long tiempoInicio = System.nanoTime();
                        String mensajeCifrado = Matriz.encrypt(mensaje);
                            long tiempoFin = System.nanoTime();

                    long duracion = tiempoFin - tiempoInicio;

                    System.out.println("Mensaje encriptado: " + mensajeCifrado);
                        System.out.println("Tiempo de encriptación: " + (duracion / 1_000_000.0) + " milisegundos.");
                    break;
